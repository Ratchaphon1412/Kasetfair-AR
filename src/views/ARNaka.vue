...
<!--       <a-entity id = "false-model" gesture-handler position = "0 0 0"  gltf-model="#mdl" take-animation></a-entity> -->
      <a-entity id = "false-model" gesture-handler scale = "2 2 2"  gltf-model="/models/nakraFullBodyColorUV.glb" ></a-entity>
